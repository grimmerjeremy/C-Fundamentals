...
namespace Conditionals
{
    ...
    public class IfElse
    {
        ...
        public void IfElseStatements()
        {
            ...
            if (totalHours >= 8)
            {
                Console.WriteLine("You should be well rested!1");
            }
            else
            {
            ...
            else
            {
                ...
                {
                    Console.WriteLine("You are too you to be on a computer.");
                }
                else
                {
            ...
            if (age > 65 || age < 18)
            {
                Console.WriteLine("Age is either Greater than or Less than 18");
            }
